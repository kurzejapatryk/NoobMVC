...
class Debuging{
  ...
  /**
   * Function addSQLDebug
   * Function adds SQL debugging
   * @return array SQL debugging array
   * @access public
   */
  public static function getSQLDebugArray() : array
  {
    return $GLOBALS['SQL_DEBUG_ARRAY'];
  }
